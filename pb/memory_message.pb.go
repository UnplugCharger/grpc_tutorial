...
const (
	...
	Memory_BYTES   Memory_Unit = 1
	Memory_KB      Memory_Unit = 2
	Memory_MB      Memory_Unit = 3
	Memory_GB      Memory_Unit = 4
	Memory_TB      Memory_Unit = 5
	Memory_PB      Memory_Unit = 6
)
...
type Memory struct {
	...
	Unit  Memory_Unit `protobuf:"varint,2,opt,name=unit,proto3,enum=grpc_tutorial.Memory_Unit" json:"unit,omitempty"`
}
...
var file_memory_message_proto_rawDesc = []byte{
	...
	0x6f, 0x72, 0x69, 0x61, 0x6c, 0x22, 0x96, 0x01, 0x0a, 0x06, 0x4d, 0x65, 0x6d, 0x6f, 0x72, 0x79,
	...
	0x20, 0x01, 0x28, 0x0e, 0x32, 0x1a, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x5f, 0x74, 0x75, 0x74, 0x6f,
	0x72, 0x69, 0x61, 0x6c, 0x2e, 0x4d, 0x65, 0x6d, 0x6f, 0x72, 0x79, 0x2e, 0x55, 0x6e, 0x69, 0x74,
	0x52, 0x04, 0x75, 0x6e, 0x69, 0x74, 0x22, 0x46, 0x0a, 0x04, 0x55, 0x6e, 0x69, 0x74, 0x12, 0x0b,
	0x0a, 0x07, 0x55, 0x4e, 0x4b, 0x4e, 0x4f, 0x57, 0x4e, 0x10, 0x00, 0x12, 0x09, 0x0a, 0x05, 0x42,
	0x59, 0x54, 0x45, 0x53, 0x10, 0x01, 0x12, 0x06, 0x0a, 0x02, 0x4b, 0x42, 0x10, 0x02, 0x12, 0x06,
	0x0a, 0x02, 0x4d, 0x42, 0x10, 0x03, 0x12, 0x06, 0x0a, 0x02, 0x47, 0x42, 0x10, 0x04, 0x12, 0x06,
	0x0a, 0x02, 0x54, 0x42, 0x10, 0x05, 0x12, 0x06, 0x0a, 0x02, 0x50, 0x42, 0x10, 0x06, 0x42, 0x05,
...
var file_memory_message_proto_goTypes = []interface{}{
	(Memory_Unit)(0), // 0: grpc_tutorial.Memory.Unit
	(*Memory)(nil),   // 1: grpc_tutorial.Memory
}
var file_memory_message_proto_depIdxs = []int32{
	0, // 0: grpc_tutorial.Memory.unit:type_name -> grpc_tutorial.Memory.Unit
